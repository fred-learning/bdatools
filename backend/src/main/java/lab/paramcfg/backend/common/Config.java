...
public class Config {
	...
	public static String REST_RESOURCE_PATH;
	public static String REST_NEWESTJOB_PATH;
	...
	static {
		try {
			...
			REST_RESOURCE_PATH = jobj.getString("rest_resource_url");
			REST_NEWESTJOB_PATH = jobj.getString("rest_job_url");
