...
select * from (select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-06-12' as date) - 30 days)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('firebrick','honeydew','misty','chocolate','moccasin','hot') and
...
select * from (select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Liberty','Midway','Union','Mount Pleasant','Centerville') 
...
and cc_county in ('Franklin Parish','Richland County','Walker County','Daviess County',
                  'Fairfield County'
)
and exists (select *
...
select * from (select  
 ...
 where
  ...
  ca_county in ('Chattahoochee County','Huntingdon County','Richland County','Jasper County','Ripley County') and
...
select * from (select  i_item_id
 ...
 and d_date between cast('2000-05-14' as date) and (cast('2000-05-14' as date) +  60 days)
 and i_manufact_id in (861,831,691,930)
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 29 and 29+10
          or ss_coupon_amt between 14872 and 14872+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 94 and 94+10
          or ss_coupon_amt between 10486 and 10486+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 44 and 44+10
          or ss_coupon_amt between 8775 and 8775+1000
...
select * from (select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 46141 and 46141+28800 
...
and d_date between '2000-01-23' and 
        (cast('2000-01-23' as date) + 90 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 2594620
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2671911
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1340238
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 3250696
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 3749000
            then (select avg(ss_ext_list_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1999) and
        ((i_category in ('Children','Music','Men') and
          i_class in ('infants','rock','accessories')
         )
      or (i_category in ('Shoes','Home','Jewelry') and
          i_class in ('womens','kids','loose stones') 
        ))
...
select * from (select  distinct(i_product_name)
 ...
 where i_manufact_id between 972 and 972+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'salmon' or i_color = 'wheat') and 
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '21498','41652','18672','43176','49632','20016',
                          '17006','90760','92075','57949','89428',
                          '40065','73468','30559','14874','38735',
                          '65421','43518','38084','79072','63405',
                          '36428','89883','63778','59687','22278',
                          '35101','16772','46306','24749','63790',
                          '75339','20681','31558','45326','71626',
                          '71103','20814','52577','62381','30579',
                          '99301','19991','45217','50043','36614',
                          '69510','99232','97450','29334','49017',
                          '33502','78735','60596','58398','36931',
                          '37851','81390','91116','45482','41532',
                          '28534','35532','42294','59114','60690',
                          '99157','37787','14715','13847','43726',
                          '19875','35622','64349','78793','34206',
                          '50567','21387','91291','17447','47040',
                          '92717','11336','29734','15538','75778',
                          '61742','12135','25110','98302','79662',
                          '39859','33654','51278','10958','36230',
                          '77982','36501','63386','77591','21208',
                          '10550','27845','73632','42874','54150',
                          '69578','52413','89609','55756','73600',
                          '98233','53600','52792','28162','64634',
                          '96185','43333','63459','45174','88902',
                          '31879','97679','69782','26082','68627',
                          '89647','44000','34303','36015','39164',
                          '92172','23544','24643','76040','28939',
                          '11079','18802','19883','69941','33971',
                          '85438','49710','95816','30808','73744',
                          '19749','16356','91892','38324','27104',
                          '17263','72811','22187','66397','70947',
                          '33692','21960','42569','69961','35955',
                          '74039','15025','21508','24281','99887',
                          '99391','80237','34157','31124','34088',
                          '21462','81940','23600','76183','51114',
                          '59338','36353','39666','64204','69198',
                          '74685','89888','20079','51775','95373',
                          '46707','72527','28477','75171','91642',
                          '87363','31218','35394','94219','44909',
                          '56783','82655','39552','16790','48229',
                          '88064','37347','40865','31695','29996',
                          '19130','90791','11648','55199','48921',
                          '27950','40204','68629','50576','14669',
                          '42222','24029','60725','65911','25738',
                          '63430','35897','40162','30210','77913',
                          '28783','27165','72483','14962','34729',
                          '20435','86896','36276','43306','47781',
                          '11731','79767','53963','51155','69471',
                          '76892','32556','60420','53227','19610',
                          '11457','27626','99094','26154','49995',
                          '41082','89012','42211','30169','54766',
                          '73630','59716','88362','95958','43285',
                          '52388','66736','60115','78925','29362',
                          '70156','77862','82661','95259','62687',
                          '82730','42172','33168','41759','16073',
                          '89676','54561','79923','22072','54599',
                          '72595','68943','11716','92965','15664',
                          '43729','27664','77729','75506','25503',
                          '15636','68400','17150','69251','44143',
                          '52425','56349','65374','39790','27489',
                          '13565','16755','92467','20126','85939',
                          '18715','24176','18376','71324','10982',
                          '12395','51445','95831','93783','29405',
                          '63629','13505','25177','18729','11871',
                          '10687','32284','96754','65785','10306',
                          '12596','71087','16518','76590','26925',
                          '87081','13068','24982','75080','98197',
                          '47502','71332','81804','72770','56675',
                          '10139','37624','95062','98834','78476',
                          '87308','72521','97788','53160','53267',
                          '63287','59799','79037','23977','20795',
                          '69675','52020','76804','69266','91546',
                          '23718','35964','93112','47169','47293',
                          '91369','19512','12248','85887','63315',
                          '28379','47909','24472','76678','10201',
                          '51996','86914','55160','46793','97674',
                          '13745','56683','15056','52687','94452',
                          '32766','16945','88404','65018','60998',
                          '41079','82219','51423','97418','27561',
                          '83228','64151','20496','97761')
     intersect
      select ca_zip
...
where 
	...
	and d_date between cast('2000-02-14' as date) 
				and (cast('2000-02-14' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select * from (select  i_item_id
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Books', 'Women', 'Electronics')
   and cs_sold_date_sk = d_date_sk
...
select * from (select  i_item_id
 ...
 and i_manufact_id in (64,463,687,702)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Richland County','Daviess County','Luce County','Ziebach County',
                           'Franklin Parish','Barrow County','Williamson County','Walker County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Fairfield County','Daviess County','Walker County','Richland County')
...
select * from (select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oak Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  631
   and ib_upper_bound   <=  631 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('antique','lavender','azure'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 5
...
select * from (select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-03-11' as date) - 30 days)
                and (cast ('2002-03-11' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select * from (select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,4,5,3,9,1) and
       d_year = 1998 and
       ca_state in ('KY','WI','SC'
                   ,'IA','TN','KS','WV')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('SC', 'NC', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TN', 'NY', 'FL')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KS', 'IL', 'AR')
...
select * from (select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Bethel','Midway')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-07-17','1998-09-20','1998-11-18')))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-15' as date) 
                  and (cast('1998-08-15' as date) +  14 days)
