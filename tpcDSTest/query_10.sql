...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('firebrick','cream','lemon','almond','sienna','midnight') and
...
select * from (select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Oak Grove','Five Points','Pleasant Hill','Fairview','Midway') 
...
select * from (select  
 ...
 where
  ...
  ca_county in ('Wyoming County','Lowndes County','Wichita County','Avery County','Hawaii County') and
...
select * from (select  i_item_id
 ...
 and i_manufact_id in (782,689,842,995)
...
where 
	...
	and d_date between cast('2002-02-18' as date) 
				and (cast('2002-02-18' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 41 and 41+10 
             or ss_coupon_amt between 12555 and 12555+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 1 and 1+10
          or ss_coupon_amt between 11413 and 11413+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 146 and 146+10
          or ss_coupon_amt between 6039 and 6039+1000
...
select * from (select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 1293 and 1293+28800 
...
i_manufact_id = 396
and i_item_sk = ws_item_sk 
and d_date between '2002-01-17' and 
        (cast('2002-01-17' as date) + 90 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 219159
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 70157
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 28377
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 117492
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 462346
            then (select avg(ss_ext_list_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2002) and
        ((i_category in ('Men','Music','Books') and
          i_class in ('sports-apparel','rock','cooking')
         )
      or (i_category in ('Shoes','Sports','Jewelry') and
          i_class in ('womens','camping','costume') 
        ))
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '53936','79839','89248','34255','19765','28221',
                          '10361','75033','64355','86995','49966',
                          '52924','24555','38703','71955','70382',
                          '65643','74428','12321','45752','99043',
                          '52128','27172','18885','74444','72772',
                          '86057','62337','71152','93724','20138',
                          '98273','14429','99970','81977','29475',
                          '47363','65603','94363','19700','34607',
                          '32374','13478','20409','57578','14572',
                          '32995','61578','79120','57841','20060',
                          '89613','83888','70316','71930','13630',
                          '53775','72147','12541','74227','49651',
                          '44700','84083','26941','82984','17083',
                          '53215','27568','86966','45334','40745',
                          '15383','31874','55447','30788','16261',
                          '99876','68881','71516','75985','69641',
                          '29975','83889','10580','54816','14604',
                          '22114','68878','95495','30064','73298',
                          '78686','11697','10172','53285','53104',
                          '90500','87418','31987','15751','14292',
                          '10459','29749','66662','51117','30529',
                          '61034','70715','54626','25570','73343',
                          '16335','29622','19550','50435','27573',
                          '89153','96221','62654','93782','85210',
                          '98190','78313','64167','63247','75073',
                          '53142','33767','82947','97660','40441',
                          '20033','83953','91648','30235','58096',
                          '21656','30192','26296','16820','34918',
                          '21768','93534','75870','13735','76525',
                          '45673','29352','22259','37214','40596',
                          '77649','12461','95683','91512','67185',
                          '72340','24751','18641','36023','27651',
                          '30345','42401','40659','56411','30023',
                          '15528','78081','15713','81858','15795',
                          '32518','34079','81846','71710','43938',
                          '83166','26365','23938','41979','45944',
                          '25516','46180','41050','21715','21628',
                          '64918','13221','27754','97012','83585',
                          '60367','21111','22702','44775','21548',
                          '50827','85254','59121','91829','71181',
                          '70315','50128','76437','70763','97296',
                          '32743','29732','10901','15584','25994',
                          '12338','39091','30550','94252','15921',
                          '76596','23843','38493','88313','11670',
                          '83886','41689','41198','25932','35284',
                          '88828','24211','64240','71881','59978',
                          '38147','27642','16172','94214','45598',
                          '33558','85327','29606','85110','34068',
                          '80504','50050','75809','13030','11687',
                          '32368','20460','17656','43629','15981',
                          '78407','75610','23198','31269','23018',
                          '44974','72242','38766','34021','15007',
                          '35484','12133','56310','56997','77755',
                          '41881','35623','63914','13146','62571',
                          '30137','33564','85401','22039','56790',
                          '74732','36421','54330','91151','81346',
                          '14001','37654','52273','84925','61854',
                          '66492','53595','18398','68030','80844',
                          '17974','24038','15144','37425','82223',
                          '17703','79335','28541','12414','52041',
                          '37130','86414','62811','95192','85453',
                          '82081','63735','12277','56186','18063',
                          '53335','56910','81487','17847','16768',
                          '17106','17649','24393','89428','48245',
                          '61450','27378','24399','51137','73196',
                          '65565','29382','30572','25218','87926',
                          '59595','62111','67433','64252','11918',
                          '22526','60176','38449','97949','29499',
                          '65402','75629','12441','38207','64763',
                          '35584','38337','18502','23506','51552',
                          '23036','12001','67034','12075','79196',
                          '20879','81364','67299','56900','23669',
                          '33730','49663','69401','35217','81551',
                          '52727','56361','75473','25093','71564',
                          '77576','28600','10771','39360','98018',
                          '55578','39096','46862','20030','72433',
                          '74866','97232','17471','33066','23313',
                          '25514','78749','27558','78384','22453',
                          '24598','99241','35183','57649','30099',
                          '21754','74158','30020','33751')
     intersect
      select ca_zip
...
select * from (select  i_item_id
 ...
 and i_manufact_id in (85,266,482,345)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select * from (select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Arlington'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  18971
   and ib_upper_bound   <=  18971 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('rosy','dim','violet'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 6
...
select * from (select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,1,12,2,11,5) and
       d_year = 1998 and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TN', 'VA', 'IN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KS', 'NM', 'TX')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('FL', 'MO', 'KY')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-05-19','1998-09-14','1998-11-19')))
